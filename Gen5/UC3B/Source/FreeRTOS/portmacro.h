...
#define PRIORITY_HIGHEST	(4U)


/*-----------------------------------------------------------*/

/* INTC-specific. */
#define DISABLE_ALL_EXCEPTIONS()    DisableException()
#define ENABLE_ALL_EXCEPTIONS()     EnableException()

#define DISABLE_ALL_INTERRUPTS()    DisableGlobalInt()
#define ENABLE_ALL_INTERRUPTS()     EnableGlobalInt()

#define DISABLE_INT_LEVEL(int_lev)  DisableLevelInt(int_lev)
#define ENABLE_INT_LEVEL(int_lev)   EnableLevelInt(int_lev)


/* Critical section management. */
#define portDISABLE_INTERRUPTS()  DisableGlobalInt()
#define portENABLE_INTERRUPTS()   EnableGlobalInt()
