...
/**
 * xTimerHandle xTimerCreate( 	const char *pcTimerName,
 ...
 * }
 */
xTimerHandle xTimerCreate( const char * const pcTimerName, portTickType xTimerPeriodInTicks, unsigned portBASE_TYPE uxAutoReload, void * pvTimerID, tmrTIMER_CALLBACK pxCallbackFunction ) PRIVILEGED_FUNCTION;
