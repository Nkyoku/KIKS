...
_handle_irq\priority:
	mov r8, AVR32_INTC_ADDRESS + AVR32_INTC_ICR + (AVR32_INTC_INT3 - \priority) * 4
	ld.w r9, r8[0]
	//lddpc r10, pIntHandlerTable
	mov r10, IntHandlerTable	// メモリー空間の最初の方にIntHandlerTable[]が配置されているときのみ有効
	ld.w r12, r10[r9<<2]
...
/*
// Pointer to IntHandlerTable[]
	.balign 4
	.global pIntHandlerTable
	.type pIntHandlerTable, @object
pIntHandlerTable:
	.word IntHandlerTable
*/
